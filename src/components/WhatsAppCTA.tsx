...
const WhatsAppCTA = () => {
  ...
  return (
    <section className="py-20 bg-gradient-teal relative overflow-hidden" ref={ref}>
      {/* Background pattern */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-primary-foreground">
              Fale direto com a gente pelo{" "}
              <span className="text-carnival-yellow">WhatsApp</span>
            </h2>

            <p className="text-primary-foreground/90 text-lg">
              Atendimento rápido e personalizado. Tire suas dúvidas e faça seu orçamento agora mesmo!
            </p>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20">
              <div className="text-center space-y-6">
                ...
                <motion.div
                  ...
                  className="w-20 h-20 bg-carnival-green rounded-full flex items-center justify-center mx-auto shadow-lg"
                >
